...
/**
 * Created by taner on 1/6/18.
 */

public class DbUtilsBegeni {
    public static final String TAG = DbUtilsBegeni.class.getSimpleName();
    ...
    public static void executeById(final Context context, final String id, @NonNull final OnQueryDbListener listener) {
        ...
        Query query = userTableRef.orderByChild("begeniID").equalTo(id);
